...
namespace RowiTechTask.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        public async System.Threading.Tasks.Task OnGetAsync(string returnUrl = null)
        {
            ...
            Input = new()
            {
                RoleList = _roleManager.Roles.Where(x => x.Name == "User").Select(i => new SelectListItem { Value = i.Name, Text = i.Name })
            };
            ReturnUrl = returnUrl;
